                        ...
                        lifecycleScope.launch {
                            val ledbars = listOf(
                                Ledbar(
                                    ...
                                    "Pirmas šviestuvas",
                                    2,
                                    """colors=0-2:255,0,0; 3:0,255,0; 4-5,7:0,0,255;"""
                                ),
                                Ledbar(
                                    "šviestuvas2",
                                    "00:00:13:00:0B:D3",
                                    "Antras šviestuvas",
                                    2,
                                    """colors=0-2:255,255,0;3-7:0,255,255;effects=0-7:Blink(500,3)"""
                                ),
                                Ledbar(
                                    "šviestuvas3",
                                    "00:00:13:00:0C:AA",
                                ...
                                Ledbar(
                                    ...
                                    2,
                                    """colors=0,2,4,6:128,0,128; 1,3,5,7:255,192,203;"""
                                ),
                                Ledbar(
                                    "šviestuvas5",
                                    "00:00:13:00:0E:CC",
                                    "Penktas šviestuvas",
                                    3,
                                    """colors=0-3:0,255,255; 4-7:255,105,180;"""
                                ),
                                Ledbar(
                                    "šviestuvas6",
                                    "00:00:13:00:0F:DD",
                                ...
                                Ledbar(
                                    ...
                                    "Aštuntas šviestuvas",
                                    3,
                                    """colors=0-3:75,0,130; 4-7:238,130,238;"""
                                ),
                                Ledbar(
                                    "šviestuvas9",
                                    "00:00:13:00:12:AB",
                                    "Devintas šviestuvas",
                                    3,
                                    """colors=0,2,4,6:0,128,0; 1,3,5,7:0,0,128;"""
                                ),
                                Ledbar(
                                    "šviestuvas10",
                                    "00:00:13:00:13:BC",
                                    "Dešimtas šviestuvas",
                                    3,
                                    """colors=0-1:255,69,0; 2-3:0,255,127; 4-5:70,130,180; 6-7:199,21,133;"""
                                )
                            )
